(function (global) {
  ...
  global.SectionManager.prototype.refreshAtTime = function (
    unixSeconds,
    positionedTrains,
    lastTime
  ) {
  ...
  global.SectionManager.prototype.addTrainToSubsection = function (
    from,
    to,
    train,
    type,
    ...
    const answered = this.sections.find(function (section) {
      ...
      const cache = {
        ...
        train: train,
        delayEvolutionOnSubsection:
          train.atTime.observed.estimatedDelayEvolution,
      };
      ...
      if (cachedTrainsContainer.length > global.subsectionsMaxCachedElements) {
        matchingSubsection.atTime[type][
          cachedDir
        ] = cachedTrainsContainer.slice(
          cachedTrainsContainer.length - global.subsectionsMaxCachedElements
        );
      }
      return true;
    });
