(function(global) {
    ...
    // DRAWING FUNCTIONS
    global.renderAllAtTime = function(unixSeconds, transitionDisabled, displayScheduled, state) {
        ...
        */
        ...
        state.positionedTrains = state.active
            .map(global.setTrainsPositions.bind(this, unixSeconds, state.preciseGraph))
